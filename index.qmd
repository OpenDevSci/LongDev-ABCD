    ...
    <div class="relative isolate overflow-hidden">
      ...
      <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
        <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <h1 class="mt-10 text-4xl font-bold tracking-tight text-center  text-white sm:text-6xl">Longitudinal Analysis Project</h1>
          <p class="mt-6 text-lg leading-8 text-gray-300">An open-source and collaborative effort guided by the Biostatistics Working Group of the <b> <a href="https://abcdstudy.org/">Adolescent Brain Cognitive Development (ABCD) Study&reg</a></b></p>
