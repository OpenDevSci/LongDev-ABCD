...
#below requires the non_imaging_excluding_nt_5.0 dataframe
annual_ABCD <-  non_imaging_excluding_nt_5.0 %>%
  filter(eventname == "baseline_year_1_arm_1" | eventname == "1_year_follow_up_y_arm_1"
         | eventname == "2_year_follow_up_y_arm_1" | eventname == "3_year_follow_up_y_arm_1" 
         |eventname == "4_year_follow_up_y_arm_1")
####
#below requires the demo5.0 dataframe to extract the sex variable
xy1 <- demo5.0[,c("src_subject_id", "eventname", "sex")]
annual_ABCD <-  merge(annual_ABCD, xy1,
...
annual_ABCD$CBCL_ADHD <- annual_ABCD$cbcl_q04_p_num1 + annual_ABCD$cbcl_q08_p_num1 + annual_ABCD$cbcl_q10_p_num1 + annual_ABCD$cbcl_q41_p_num1 +
  annual_ABCD$cbcl_q78_p_num1 + annual_ABCD$cbcl_q93_p_num1 + annual_ABCD$cbcl_q104_p_num1
...
#the resulting dataframe should have 22810 observations (4562 participants)
#####################
#####################
