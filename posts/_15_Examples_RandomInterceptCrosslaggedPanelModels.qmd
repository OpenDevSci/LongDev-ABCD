...
model <- '
  # Random intercepts
  i_X =~ 1 * anthroheightcalc_0 + 1 * anthroheightcalc_1 + 1 * anthroheightcalc_2 + 1 * anthroheightcalc_3 + 1 * anthroheightcalc_4
  i_Y =~ 1 * anthroweightcalc_0 + 1 * anthroweightcalc_1 + 1 * anthroweightcalc_2 + 1 * anthroweightcalc_3 + 1 * anthroweightcalc_4

  # Cross-lagged effects
  anthroweightcalc_1 ~ beta_YX * anthroheightcalc_0
  anthroweightcalc_2 ~ beta_YX * anthroheightcalc_1
  anthroweightcalc_3 ~ beta_YX * anthroheightcalc_2
  anthroweightcalc_4 ~ beta_YX * anthroheightcalc_3

  anthroheightcalc_1 ~ beta_XY * anthroweightcalc_0
  anthroheightcalc_2 ~ beta_XY * anthroweightcalc_1
  anthroheightcalc_3 ~ beta_XY * anthroweightcalc_2
  anthroheightcalc_4 ~ beta_XY * anthroweightcalc_3

  # Auto-regressive paths (optional but often included in CLPM)
  anthroheightcalc_1 ~ alpha_X * anthroheightcalc_0
  anthroheightcalc_2 ~ alpha_X * anthroheightcalc_1
  anthroheightcalc_3 ~ alpha_X * anthroheightcalc_2
  anthroheightcalc_4 ~ alpha_X * anthroheightcalc_3

  anthroweightcalc_1 ~ alpha_Y * anthroweightcalc_0
  anthroweightcalc_2 ~ alpha_Y * anthroweightcalc_1
  anthroweightcalc_3 ~ alpha_Y * anthroweightcalc_2
  anthroweightcalc_4 ~ alpha_Y * anthroweightcalc_3

  # Covariances (optional but can be included for model fit)
  anthroheightcalc_0 ~~ anthroweightcalc_0
  i_X ~~ i_Y
  '
```
