...
model <- '
  # Trait component
  trait =~ 1 * height_Baseline + 1 * height_Year_1 + 1 * height_Year_2 + 1 * height_Year_3

  # State component
  state =~ height_Baseline + height_Year_1 + height_Year_2 + height_Year_3

  # Residual variances
  height_Baseline ~~ height_Baseline
  height_Year_1 ~~ height_Year_1
  height_Year_2 ~~ height_Year_2
  height_Year_3 ~~ height_Year_3
'
