...
## Results 
### Compute Latent State-Trait Model
This code performs latent state-trait analysis to examine xxxxx. The model output is provided below, along with a summary of results. This approach xxxxx.
...
model <- '
  # Trait component
  trait =~ 1 * anthroheightcalc_0 + 1 * anthroheightcalc_1 + 1 * anthroheightcalc_2 + 1 * anthroheightcalc_3

  # State component
  state =~ anthroheightcalc_0 + anthroheightcalc_1 + anthroheightcalc_2 + anthroheightcalc_3

  # Residual variances
  anthroheightcalc_0 ~~ anthroheightcalc_0
  anthroheightcalc_1 ~~ anthroheightcalc_1
  anthroheightcalc_2 ~~ anthroheightcalc_2
  anthroheightcalc_3 ~~ anthroheightcalc_3
'

# Estimate the State-Trait Model
...
## Wrapping Up
The latent state-trait analysis revealed xxxxxxxx.
