...
model <- '
  # Latent variables
  intercept =~ 1 * anthroheightcalc_0 + 1 * anthroheightcalc_1 + 1 * anthroheightcalc_2 + 1 * anthroheightcalc_3 + 1 * anthroheightcalc_4
  slope =~ 0 * anthroheightcalc_0 + 1 * anthroheightcalc_1 + 2 * anthroheightcalc_2 + 3 * anthroheightcalc_3 + 4 * anthroheightcalc_4

  # Time-varying covariate effect on outcome
  anthroheightcalc_0 ~ c1 * anthroweightcalc_0
  anthroheightcalc_1 ~ c2 * anthroweightcalc_1
  anthroheightcalc_2 ~ c3 * anthroweightcalc_2
  anthroheightcalc_3 ~ c4 * anthroweightcalc_3
  anthroheightcalc_4 ~ c5 * anthroweightcalc_4

  # Residual variances and covariances
  anthroheightcalc_0 ~~ r1 * anthroheightcalc_0
  anthroheightcalc_1 ~~ r2 * anthroheightcalc_1
  anthroheightcalc_2 ~~ r3 * anthroheightcalc_2
  anthroheightcalc_3 ~~ r4 * anthroheightcalc_3
  anthroheightcalc_4 ~~ r5 * anthroheightcalc_4
