...
model <- '
  ...
  i_var1 =~ 1*anthroheightcalc_0 + 1*anthroheightcalc_1 + 1*anthroheightcalc_2
  s_var1 =~ 0*anthroheightcalc_0 + 1*anthroheightcalc_1 + 2*anthroheightcalc_2

  # Intercept and slope factors for variable 2
  i_var1 =~ 1*anthroweightcalc_0 + 1*anthroweightcalc_1 + 1*anthroweightcalc_2
  s_var1 =~ 0*anthroweightcalc_0 + 1*anthroweightcalc_1 + 2*anthroweightcalc_2
'
```
