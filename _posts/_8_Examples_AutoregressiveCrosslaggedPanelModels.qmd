...
# Autoregressive Crosslagged Panel Models {.unnumbered}

## Overview

<p>

Autoregressive Crosslagged Panel (ARCL) Models xxxxxxx. This xxxxxxx.

In this example, we will utilize ARCL models to analyze xxxxxx obtained across multiple measurement occasions for a sample of youth participating in the ABCD Study. Our primary objective is to understand xxxxxx, while factoring in the clustered nature of observations within individuals over time. ARCL models facilitate this by xxxxx.
...
packages_required <- c("tidyverse","rstatix","DT","lavaan")
...
library(lavaan)       # Structural equation modeling package
...
model <- '
  ...
  anthroweightcalc_4 ~ a1 * anthroweightcalc_3
  anthroweightcalc_3 ~ a2 * anthroweightcalc_2
  anthroweightcalc_2 ~ a1 * anthroweightcalc_1
  anthroweightcalc_1 ~ a2 * anthroweightcalc_0
  anthroheightcalc_4 ~ a1 * anthroheightcalc_3
  anthroheightcalc_3 ~ a2 * anthroheightcalc_2
  anthroheightcalc_2 ~ a1 * anthroheightcalc_1
  anthroheightcalc_1 ~ a2 * anthroheightcalc_0
  
# Cross-lagged paths
anthroheightcalc_4 ~ b1 * anthroweightcalc_3
anthroheightcalc_3 ~ b1 * anthroweightcalc_2
anthroheightcalc_2 ~ b1 * anthroweightcalc_1
anthroheightcalc_1 ~ b2 * anthroweightcalc_0
  
anthroweightcalc_4 ~ b1 * anthroheightcalc_3
anthroweightcalc_3 ~ b1 * anthroheightcalc_2
anthroweightcalc_2 ~ b1 * anthroheightcalc_1
anthroweightcalc_1 ~ b2 * anthroheightcalc_0
'
